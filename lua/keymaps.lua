...
vim.keymap.set('n', '<leader>fo', ':Oil<CR>', options)
...
vim.keymap.set('n', '<leader>fh', ':FzfLua helptags<cr>', options)
vim.keymap.set('n', '<leader>fk', ':FzfLua keymaps<cr>', options)
vim.keymap.set('n', '<leader>ag', ':FzfLua grep_project<cr>', options)
vim.keymap.set('n', '<leader>ss', ':FzfLua blines<cr>', options)

vim.keymap.set('n', '<leader>mp', '<Plug>MarkdownPreview<cr>', options)
